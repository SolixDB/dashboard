...
export default function BillingPageRoute() {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (syncedUser) {
          ...
          // If no credits record, fetch from database or create default
          if (!data) {
            const planCredits = syncedUser.plan === "free" ? 1000 : syncedUser.plan === "x402" ? 25000 : 100000
  ...
  const defaultCredits = credits || {
    total_credits: userProfile.plan === "free" ? 1000 : userProfile.plan === "x402" ? 25000 : 100000,
    used_credits: 0,
  }
